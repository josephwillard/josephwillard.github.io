...
How do we match graphs like [4](#org4e73f52) such that we obtain we obtain
the argument of the "Svd" operator (i.e `S`, the [5](#org7ea3d77))? 
...
Now, we want to unify [4](#org4e73f52) with another graph containing a
...
case. The output would be a new graph where [4](#org4e73f52) has been
