...
involved removing the `from_obj` method from `MetaSymbol` ([[https://github.com/pymc-devs/symbolic-pymc/pull/15][#15]]). `from_obj`
...
as minikanren. I was able to close issue ([[https://github.com/pymc-devs/symbolic-pymc/pull/41][#41]]) which involved
...
closing the pull request related to graph indexing ([[https://github.com/pymc-devs/symbolic-pymc/pull/60][#60]]) and will move on to
